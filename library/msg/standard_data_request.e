...
--| {
--|   "header": {
--|     "id":  <standard_data_request_id=10>
--|   },
--|   "data": {
--|     "sensors_list": [{
--|                        "sensor_id": id1,
...
feature -- Access
	...
	id: INTEGER
			-- message id
		do
			Result := standard_data_request_id
		end
...
feature -- Conversion
	...
	to_json: STRING
		...
		do
			...
			Result.append (double_quotes + json_id_tag + double_quotes + colon + space + standard_data_request_id.out + right_brace)
			...
			loop
				...
				Result.append (double_quotes + json_start_tag + double_quotes + colon + space + double_quotes + sensors_list.item.start.formatted_out (default_date_time_format)  + double_quotes + comma)
				Result.append (double_quotes + json_finish_tag + double_quotes + colon + space + double_quotes + sensors_list.item.finish.formatted_out (default_date_time_format) + double_quotes + right_brace)
...
feature -- Basic operations
	...
	init_response: RESPONSE_I
			--
		do
			Result := create {STANDARD_DATA_RESPONSE}.make
		end
...
feature {NONE} -- Utilities implementation
	...
	name: STRING
		...
		do
			Result := standard_data_endpoint_name
		end
...
--			]"
			...
			create Result.make_empty
			Result.append (stag_start + xmlns_s + colon + soap_envelope + space + xmlns + colon + xmlns_s + eq_s + double_quotes + xmlsoap + double_quotes + lf_s)
			  Result.append (double_space + xmlns + colon + xmlns_xsi + eq_s + double_quotes + xml_schema_instance + double_quotes + lf_s)
			  Result.append (double_space + xmlns + colon + xmlns_xsd + eq_s + double_quotes + xml_schema + double_quotes + stag_end + lf_s)
			  Result.append (double_space + stag_start + xmlns_s + colon + body + stag_end + lf_s)
			    Result.append (double_space + double_space + stag_start + standard_data_endpoint_name + space + xmlns + eq_s + double_quotes + remws_uri + url_path_separator + double_quotes + stag_end + lf_s)
				  Result.append (double_space + double_space + double_space + stag_start + xinput + stag_end + lf_s)
				    Result.append (double_space + double_space + double_space + double_space + stag_start + standard_data_endpoint_name + space + xmlns + eq_s + double_quotes + double_quotes + stag_end + lf_s)
				      ...
				      Result.append (double_space + double_space + double_space + double_space + double_space + it_sensors + lf_s)
				    Result.append (double_space + double_space + double_space + double_space + etag_start + standard_data_endpoint_name + etag_end + lf_s)
				  Result.append (double_space + double_space + double_space + etag_start + xinput + etag_end + lf_s)
				Result.append (double_space + double_space + etag_start + standard_data_endpoint_name + etag_end + lf_s)
