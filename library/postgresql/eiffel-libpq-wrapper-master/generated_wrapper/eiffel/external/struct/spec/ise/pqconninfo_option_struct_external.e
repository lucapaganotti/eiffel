...
feature {NONE} -- Implementation
	...
	set_keyword_external (an_item: POINTER; a_value: POINTER)
		...
		external
			"C [macro <ewg_postgres_struct_c_glue_code.h>]"
		alias
			"ewg_struct_macro_struct__PQconninfoOption_member_set_keyword"
		ensure
	...
	set_envvar_external (an_item: POINTER; a_value: POINTER)
		...
		external
			"C [macro <ewg_postgres_struct_c_glue_code.h>]"
		alias
			"ewg_struct_macro_struct__PQconninfoOption_member_set_envvar"
		ensure
	...
	set_compiled_external (an_item: POINTER; a_value: POINTER)
		...
		external
			"C [macro <ewg_postgres_struct_c_glue_code.h>]"
		alias
			"ewg_struct_macro_struct__PQconninfoOption_member_set_compiled"
		ensure
	...
	set_val_external (an_item: POINTER; a_value: POINTER)
		...
		external
			"C [macro <ewg_postgres_struct_c_glue_code.h>]"
		alias
			"ewg_struct_macro_struct__PQconninfoOption_member_set_val"
		ensure
	...
	set_label_external (an_item: POINTER; a_value: POINTER)
		...
		external
			"C [macro <ewg_postgres_struct_c_glue_code.h>]"
		alias
			"ewg_struct_macro_struct__PQconninfoOption_member_set_label"
		ensure
	...
	set_dispchar_external (an_item: POINTER; a_value: POINTER)
		...
		external
			"C [macro <ewg_postgres_struct_c_glue_code.h>]"
		alias
			"ewg_struct_macro_struct__PQconninfoOption_member_set_dispchar"
		ensure
	...
	set_dispsize_external (an_item: POINTER; a_value: INTEGER)
		...
		external
			"C [macro <ewg_postgres_struct_c_glue_code.h>]"
		alias
			"ewg_struct_macro_struct__PQconninfoOption_member_set_dispsize"
		ensure
