...
feature {NONE} -- Implementation
	...
	set_relname_external (an_item: POINTER; a_value: POINTER)
		...
		external
			"C [macro <ewg_postgres_struct_c_glue_code.h>]"
		alias
			"ewg_struct_macro_struct_pgNotify_member_set_relname"
		ensure
	...
	set_be_pid_external (an_item: POINTER; a_value: INTEGER)
		...
		external
			"C [macro <ewg_postgres_struct_c_glue_code.h>]"
		alias
			"ewg_struct_macro_struct_pgNotify_member_set_be_pid"
		ensure
	...
	set_extra_external (an_item: POINTER; a_value: POINTER)
		...
		external
			"C [macro <ewg_postgres_struct_c_glue_code.h>]"
		alias
			"ewg_struct_macro_struct_pgNotify_member_set_extra"
		ensure
	...
	set_next_external (an_item: POINTER; a_value: POINTER)
		...
		external
			"C [macro <ewg_postgres_struct_c_glue_code.h>]"
		alias
			"ewg_struct_macro_struct_pgNotify_member_set_next"
		ensure
