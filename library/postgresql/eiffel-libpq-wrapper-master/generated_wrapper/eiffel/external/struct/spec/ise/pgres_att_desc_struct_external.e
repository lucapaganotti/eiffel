...
feature {NONE} -- Implementation
	...
	set_name_external (an_item: POINTER; a_value: POINTER)
		...
		external
			"C [macro <ewg_postgres_struct_c_glue_code.h>]"
		alias
			"ewg_struct_macro_struct_pgresAttDesc_member_set_name"
		ensure
	...
	set_tableid_external (an_item: POINTER; a_value: INTEGER)
		...
		external
			"C [macro <ewg_postgres_struct_c_glue_code.h>]"
		alias
			"ewg_struct_macro_struct_pgresAttDesc_member_set_tableid"
		ensure
	...
	set_columnid_external (an_item: POINTER; a_value: INTEGER)
		...
		external
			"C [macro <ewg_postgres_struct_c_glue_code.h>]"
		alias
			"ewg_struct_macro_struct_pgresAttDesc_member_set_columnid"
		ensure
	...
	set_format_external (an_item: POINTER; a_value: INTEGER)
		...
		external
			"C [macro <ewg_postgres_struct_c_glue_code.h>]"
		alias
			"ewg_struct_macro_struct_pgresAttDesc_member_set_format"
		ensure
	...
	set_typid_external (an_item: POINTER; a_value: INTEGER)
		...
		external
			"C [macro <ewg_postgres_struct_c_glue_code.h>]"
		alias
			"ewg_struct_macro_struct_pgresAttDesc_member_set_typid"
		ensure
	...
	set_typlen_external (an_item: POINTER; a_value: INTEGER)
		...
		external
			"C [macro <ewg_postgres_struct_c_glue_code.h>]"
		alias
			"ewg_struct_macro_struct_pgresAttDesc_member_set_typlen"
		ensure
	...
	set_atttypmod_external (an_item: POINTER; a_value: INTEGER)
		...
		external
			"C [macro <ewg_postgres_struct_c_glue_code.h>]"
		alias
			"ewg_struct_macro_struct_pgresAttDesc_member_set_atttypmod"
		ensure
