...
feature
	get_pqnotice_receiver_stub: POINTER
		local
		do
			Result := get_pqnotice_receiver_stub_external
		end

	set_pqnotice_receiver_entry (a_class: PQNOTICE_RECEIVER_DISPATCHER; a_feature: POINTER)
		local
		do
			set_pqnotice_receiver_entry_external (a_class, a_feature)
		end

	call_pqnotice_receiver (a_function: POINTER; arg: POINTER; res: POINTER)
		local
		do
			call_pqnotice_receiver_external (a_function, arg, res)
		end

	get_pqnotice_processor_stub: POINTER
		local
		do
			Result := get_pqnotice_processor_stub_external
		end

	set_pqnotice_processor_entry (a_class: PQNOTICE_PROCESSOR_DISPATCHER; a_feature: POINTER)
		local
		do
			set_pqnotice_processor_entry_external (a_class, a_feature)
		end

	call_pqnotice_processor (a_function: POINTER; arg: POINTER; message: STRING)
		local
	...
	get_pgthreadlock_t_stub: POINTER
		local
		do
			Result := get_pgthreadlock_t_stub_external
		end

	set_pgthreadlock_t_entry (a_class: PGTHREADLOCK_T_DISPATCHER; a_feature: POINTER)
		local
		do
			set_pgthreadlock_t_entry_external (a_class, a_feature)
		end

	call_pgthreadlock_t (a_function: POINTER; acquire: INTEGER)
		local
		do
