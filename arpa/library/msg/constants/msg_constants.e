...
feature -- Constants
	...
	--| ---------------------------------------------------------------------------
	--| REALTIME DATA METEO request and response constants
	--| ---------------------------------------------------------------------------
	realtime_data_meteo_request_id:              INTEGER = 13
			-- Message id for `REALTIME_DATA_REQUEST'
	realtime_data_meteo_response_id:             INTEGER do Result := response_id_offset + realtime_data_meteo_request_id end
			-- Message id for `REALTIME_DATA_RESPONSE'
